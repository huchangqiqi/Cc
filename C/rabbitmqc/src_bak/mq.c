...
/*
 * dest 
 * routingkey  指定queue的名字
 */
int send_msg(char * msg,char *dest)
{
...
/*
 * 以mode_name 为bindingkey ,创建 queue ,把exchange binding 到 queue
 */
int register_mode(char* mode_name)
{
