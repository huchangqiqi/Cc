...
static const ProtobufCFieldDescriptor search_request__field_descriptors[4] =
{
  ...
  },
  {
    ...
    offsetof(SearchRequest, has_page_number),
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(SearchRequest, has_result_per_page),
  ...
  },
  {
    ...
    offsetof(SearchRequest, has_corpus),
...
static const ProtobufCEnumValue enum_allowing_alias__enum_values_by_number[2] =
{
  { "UNKNOWN", "ENUM_ALLOWING_ALIAS__UNKNOWN", 0 },
  { "STARTED", "ENUM_ALLOWING_ALIAS__STARTED", 1 },
};
static const ProtobufCIntRange enum_allowing_alias__value_ranges[] = {
{0, 0},{0, 2}
};
static const ProtobufCEnumValueIndex enum_allowing_alias__enum_values_by_name[3] =
{
  { "RUNNING", 1 },
  { "STARTED", 1 },
  { "UNKNOWN", 0 },
};
const ProtobufCEnumDescriptor enum_allowing_alias__descriptor =
{
  PROTOBUF_C__ENUM_DESCRIPTOR_MAGIC,
  "EnumAllowingAlias",
  "EnumAllowingAlias",
  ...
  "",
  2,
  enum_allowing_alias__enum_values_by_number,
  3,
  enum_allowing_alias__enum_values_by_name,
  1,
  enum_allowing_alias__value_ranges,
  NULL,NULL,NULL,NULL   /* reserved[1234] */
};
